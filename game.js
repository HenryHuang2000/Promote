(function () {
  ...
  function big_two_logic(socket, io, gameData) {
      ...
      socket.on('cardsPlayed', function(playerAction) {
          ...
          else if (legalTurn && legalLength && size_checker(cards) && cards.length != 0) legal_logic();
          // Process illegal plays.
          else {
              let reasons = [legalTurn, !mustPlay, legalLength, combo_checker(cards), size_checker(cards)];
          ...
          function combo_checker(cards) {
              ...
              // For 5 card combos.
              else if (cards.length == 5 && combo_size(cards) != 0) return true;
          ...
          function combo_type(cards) {
              ...
              if (cardNum1 + cardNum2 == 5) {
                  ...
                  // Check for bombs.
                  if (!(cardNum1 == 1 || cardNum2 == 1)) comboType &= 7;
              } else comboType &= 3;
